...
<div class="main-header">
    ...
    <p>Tác giả: Giàng Thị Ngân - Trường PTDTBT Tiểu học Đường Thượng - ĐT: 0962913206</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Giàng Thị Ngân - Trường PTDTBT Tiểu học Đường Thượng - ĐT: 0962913206</div>", unsafe_allow_html=True)
